...
Test.prototype.setBeforeEachHandler = function (handlers) {
  this._beforeEach_handlers = handlers;
}
...
Test.prototype.run = function () {
  ...
  if (this._beforeEach_handlers.length) {
    for (var i in this._beforeEach_handlers) {
      this._beforeEach_handlers[i](this);
    }
  }
